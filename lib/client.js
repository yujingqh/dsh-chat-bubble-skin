...
window.__ModuleLoader__.load({
  ...
  factory: (_require) => {
    ...
    // 说明：assistant 正文容器类名 (.Sxvs8a_body) 是稳定的；markdown 容器 _markdown_xxx 的
    // hash 后缀会随 DSH 版本变化，因此统一用 .Sxvs8a_body 作为稳定锚点。
    ACCENTS.forEach((a, i) => {
    ...
    //   a) `[data-dsh-bubble-ai][data-chat-flow-kind] .Sxvs8a_body * { color:#fff !important }`
